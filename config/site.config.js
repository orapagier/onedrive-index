...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'uzziel@samuzziel.onmicrosoft.com',
  ...
  title: "Sam Uziel's OneDrive",

  // The folder that you are to share publicly with onedrive-vercel-index. Use '/' if you want to share your root folder.
  baseDirectory: '/Google Drive Sync',
  ...
  footer:
    'Copyright © 2022 | Sam Uzziel Orapa | All Rights Reserved.',
  ...
  email: 'mailto:orapajelmar@gmail.com',
